                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden transition-all post-card">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <?php if ($p['subtitle']): ?>
                                <p class="card-subtitle text-muted mb-3 small"><?php echo htmlspecialchars($p['subtitle']); ?></p>
                            <?php endif; ?>

                            <p class="card-text text-muted flex-grow-1 small">
                                <?php echo htmlspecialchars(substr(strip_tags($p['content']), 0, 120)) . (strlen(strip_tags($p['content'])) > 120 ? '...' : ''); ?>
                            </p>
